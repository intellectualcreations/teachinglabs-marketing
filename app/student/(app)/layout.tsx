    ...
    async function init() {
      try {
        ...
        if (!profileData) {
          ...
          profileData = pd as typeof profileData;
        }

        const displayName = profileData?.preferred_name || profileData?.display_name || 'Student';
        setSuperpowerTitle(profileData?.superpower_title || '');
