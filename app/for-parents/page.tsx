    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-warm-white dark:bg-deep-navy">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          >
            <span className="hero-text-black hero-word hero-word-0 dark:text-white">You Don&apos;t Have to Wonder</span>
            <br />
            <span className="hero-text-black hero-word hero-word-1 dark:text-white">What Your Child Is</span>{' '}
            <span
