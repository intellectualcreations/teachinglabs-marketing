      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-warm-white">
        ...
        <div className="relative z-10 text-center max-w-[960px] px-12 max-md:px-6">
          ...
          <div className="hero-buttons-anim-late flex gap-4 justify-center flex-wrap">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 font-heading text-base font-bold bg-transparent text-deep-navy dark:text-white border-2 border-gold hover:bg-gold px-10 py-4 rounded-full hover:-translate-y-0.5 hover:shadow-[0_6px_28px_rgba(64,86,244,0.45)] transition-all duration-300"
            >
