    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-warm-white dark:bg-deep-navy">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          >
            <span className="hero-text-black hero-word hero-word-0 dark:text-white">AI Is Here.</span>{' '}
            <span
          ...
          <p className="hero-subtitle-anim hero-text-black font-body text-xl leading-[1.7] mb-5 max-w-[680px] mx-auto dark:!text-white/70">
