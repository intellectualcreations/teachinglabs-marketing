    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-warm-white dark:bg-deep-navy">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          >
            <span className="text-black dark:text-white hero-word hero-word-0 dark:text-white">Built to Support</span>
            <br />
            <span className="text-black dark:text-white hero-word hero-word-1 dark:text-white">For</span>{' '}
            <span
            ...
            <span className="text-black dark:text-white hero-word hero-word-3 dark:text-white">Teacher.</span>
          </h1>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-warm-white dark:bg-transparent">
          ...
          <div className="relative z-10 max-w-[800px] mx-auto px-12 py-36 text-center max-md:px-6 max-md:py-20">
            ...
            <p className="text-black dark:text-white text-lg leading-[1.7] mb-10 max-w-[500px] mx-auto dark:!text-white/65">
            ...
            <div>
              ...
              <ul className="space-y-3 list-none">
                {[
                  ...
                  <li key={href}>
                    <Link href={href} className="text-sm text-black dark:text-white/90 hover:text-gold transition-colors duration-200">{label}</Link>
                  </li>
                ))}
              </ul>
            </div>
