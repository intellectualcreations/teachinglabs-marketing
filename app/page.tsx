      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-warm-white dark:bg-deep-navy">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          <h1 className="font-heading font-extrabold tracking-[-2px] leading-[1.15] mb-6"
            ...
            <span className="hero-text-black hero-word hero-word-0 mr-2">Your</span>
            <span className="hero-text-black hero-word hero-word-1 mr-2">Teaching</span>
            <span className="hero-text-black hero-word hero-word-2 mr-2">Power,</span>
            <span
          ...
          {/* Subtitle */}
          <p className="hero-subtitle-anim hero-text-black font-body text-xl leading-[1.7] mb-10 max-w-[620px] mx-auto">
            Not another edtech tool.<br />
            A teaching assistant built from your expertise.
          </p>

          {/* Intro line */}
          <p className="hero-intro-anim hero-text-black font-body text-[19px] leading-[1.7] mb-10 max-w-[700px] mx-auto max-md:text-[17px]">
