...
function goalGuidanceFor(goalType?: string, topic?: string): string {
  ...
  switch (goalType) {
    case 'practice':
      return `\n\n[SESSION GOAL — PRACTICE MODE]\nThe student set their goal: they want to PRACTICE ${goal}.\n\nCRITICAL BEHAVIOR — MINIMIZE YOUR TALKING, MAXIMIZE THEIR DOING:\n- Your FIRST response: "Grab a pencil and paper. Here's your first problem: [problem]. Work it out and send me your answer (or a photo of your paper)."\n- NO lengthy explanations. NO review of concepts unless they get it wrong twice.\n- Offer physical tools when they fit: fraction circles, dice, measuring cups, counters, LEGO blocks, coins, index cards. "Get out your fraction circles" / "Grab some coins" / "Use blocks to show me."\n- Every message of yours should end with an ACTION for the student: solve this, draw this, build this, photograph this.\n- Keep responses SHORT — 2-3 sentences max unless giving feedback on their work. Students should be doing 80% of the work, you 20%.\n- When they answer: "✅ right!" or "Close — check [hint]." Then next problem. Don't over-explain a right answer.\n- Go from easier to harder. After 3-4 correct, celebrate and ask: "Keep going? Level up? Or wrap here?"`;
    case 'write':
