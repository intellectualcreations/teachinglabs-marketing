...
function IconDiverge() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
        <linearGradient id="ig1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#4056F4" />
          <stop offset="100%" stopColor="#561F37" />
        </linearGradient>
      </defs>
      <path d="M24 8 C16 16, 8 28, 8 36" stroke="url(#ig1)" strokeWidth="2.5" strokeLinecap="round" opacity="0.9" />
      <path d="M24 8 C24 18, 24 28, 24 38" stroke="url(#ig1)" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />
      <path d="M24 8 C32 16, 40 28, 40 36" stroke="url(#ig1)" strokeWidth="2.5" strokeLinecap="round" opacity="0.4" />
    </svg>
  );
}
...
function IconConcentric() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
      ...
      <circle cx="24" cy="24" r="8" stroke="url(#ig2)" strokeWidth="2.5" opacity="0.9" />
      <circle cx="24" cy="24" r="14" stroke="url(#ig2)" strokeWidth="2" opacity="0.6" />
      <circle cx="24" cy="24" r="20" stroke="url(#ig2)" strokeWidth="1.5" opacity="0.35" />
    </svg>
  );
}
...
function IconNetwork() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
      ...
      <circle cx="14" cy="14" r="4" stroke="url(#ig3)" strokeWidth="2" opacity="0.7" />
      <circle cx="34" cy="14" r="4" stroke="url(#ig3)" strokeWidth="2" opacity="0.7" />
      <circle cx="24" cy="30" r="4" stroke="url(#ig3)" strokeWidth="2" opacity="0.9" />
      <circle cx="10" cy="38" r="3" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.5" />
      <circle cx="38" cy="38" r="3" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.5" />
      <line x1="14" y1="18" x2="24" y2="26" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.5" />
      <line x1="34" y1="18" x2="24" y2="26" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.5" />
      <line x1="24" y1="34" x2="10" y2="35" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.4" />
      <line x1="24" y1="34" x2="38" y2="35" stroke="url(#ig3)" strokeWidth="1.5" opacity="0.4" />
    </svg>
  );
}
...
function IconOrbit() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
      ...
      <ellipse cx="24" cy="24" rx="20" ry="10" stroke="url(#ig4)" strokeWidth="2" opacity="0.4" transform="rotate(-30 24 24)" />
      <ellipse cx="24" cy="24" rx="20" ry="10" stroke="url(#ig4)" strokeWidth="2" opacity="0.6" transform="rotate(30 24 24)" />
      <ellipse cx="24" cy="24" rx="20" ry="10" stroke="url(#ig4)" strokeWidth="2" opacity="0.8" transform="rotate(90 24 24)" />
...
function IconFunnel() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
      ...
      <path d="M8 12 Q18 24, 24 36" stroke="url(#ig5)" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />
      <path d="M24 12 Q24 24, 24 36" stroke="url(#ig5)" strokeWidth="2.5" strokeLinecap="round" opacity="0.8" />
      <path d="M40 12 Q30 24, 24 36" stroke="url(#ig5)" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />
...
function IconVenn() {
  return (
    <svg viewBox="0 0 48 48" fill="none" className="w-12 h-12"><defs>
      ...
      <circle cx="18" cy="24" r="10" stroke="url(#ig6)" strokeWidth="2" opacity="0.6" />
      <circle cx="30" cy="24" r="10" stroke="url(#ig6)" strokeWidth="2" opacity="0.6" />
      <circle cx="24" cy="16" r="10" stroke="url(#ig6)" strokeWidth="2" opacity="0.4" />
    </svg>
  );
}
...
export default function HomePage() {
  return (
    <>
      {/* Demo-only nav — does not affect shared MarketingNav */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 dark:border-white/[0.06]" style={{ background: 'color-mix(in srgb, var(--color-surface) 97%, transparent)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)' }}>
        <div className="max-w-[1200px] mx-auto px-12 h-[72px] flex items-center justify-between max-md:px-6">
          <Link href="/demo" className="font-heading text-[22px] font-bold text-text-primary tracking-tight">Teaching Labs</Link>
          <div className="hidden md:flex items-center gap-8">
            <Link href="/for-teachers" className="font-heading text-[15px] font-semibold text-text-primary dark:text-text-secondary hover:text-teal dark:hover:text-gold transition-colors">For Teachers</Link>
            <Link href="/for-students" className="font-heading text-[15px] font-semibold text-text-primary dark:text-text-secondary hover:text-teal dark:hover:text-gold transition-colors">For Students</Link>
            <Link href="/for-districts" className="font-heading text-[15px] font-semibold text-text-primary dark:text-text-secondary hover:text-teal dark:hover:text-gold transition-colors">For Districts</Link>
            <Link href="/for-parents" className="font-heading text-[15px] font-semibold text-text-primary dark:text-text-secondary hover:text-teal dark:hover:text-gold transition-colors">For Parents</Link>
            <Link href="/contact" className="font-heading text-[15px] font-semibold text-text-primary dark:text-text-secondary hover:text-teal dark:hover:text-gold transition-colors">Contact</Link>
          </div>
          <div className="flex items-center gap-4">
            <ThemeToggle className="border-border text-text-secondary hover:text-text-primary hover:border-navy" />
            <Link href="/signup" className="font-heading text-sm font-bold bg-gold text-deep-navy px-6 py-2.5 rounded-full hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(240,201,93,0.3)] transition-all duration-300">Sign Up Now</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-warm-white">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          <div className="hero-buttons-anim flex gap-4 justify-center flex-wrap mb-8">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 font-heading text-base font-bold bg-transparent text-text-primary px-10 py-4 rounded-full border-4 border-teal hover:bg-teal hover:text-white hover:-translate-y-0.5 transition-all duration-300"
            >
              Sign Up Now
            </Link>
          </div>
        ...
        <section className="relative overflow-hidden fade-up" style={{ background: 'linear-gradient(145deg, #14213D 0%, #1a3a4a 50%, #1d4a52 100%)' }}>
          ...
          <div className="relative z-10 max-w-[800px] mx-auto px-12 py-36 text-center max-md:px-6 max-md:py-20">
            ...
            <h2 className="font-heading font-extrabold tracking-[-1.5px] text-white mb-5 leading-[1.15]"
              style={{ fontSize: 'clamp(36px, 5vw, 56px)' }}>
              Ready to Experience Teaching Labs?
            </h2>
