    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-warm-white dark:bg-deep-navy">
        ...
        <div className="relative z-10 text-center max-w-[900px] px-12 max-md:px-6">
          ...
          >
            <span className="text-black dark:text-white hero-word hero-word-0 dark:text-white">Support for the Moments</span>
            <br />
            <span className="text-black dark:text-white hero-word hero-word-1 dark:text-white">Teachers Face</span>
            <br />
            <span
