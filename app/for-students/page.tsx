  ...
  return (
    ...
    >
        ...
        <div className="max-w-[1200px] mx-auto px-12 h-[72px] flex items-center justify-between max-md:px-6">
          ...
          <ul className="hidden md:flex items-center gap-8 list-none">
            {[
              ...
              { href: '/for-students', label: 'For Students', active: true },
            ...
            <li className="group relative">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"><div className="bg-card-bg border border-border rounded-xl py-2 min-w-[200px] shadow-[0_12px_40px_rgba(0,0,0,0.12)] z-50">
                {[
      ...
      <main>
        ...
        {/* Photo 1 */}
        <div className="bg-warm-white pb-12 px-12 max-md:px-6">
          <div className="max-w-[760px] mx-auto rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(20,33,61,0.15)]">
