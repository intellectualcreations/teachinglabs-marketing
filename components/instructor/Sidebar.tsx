...
const NAV_ITEMS = [
  ...
  { label: 'Office Hours', href: '/instructor/office-hours', icon: 'chat' },
      ...
      >
        ...
        <div className="px-5 py-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-[10px] bg-teal/20 flex items-center justify-center">
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive
                    ? 'bg-white/10 text-white border-r-2 border-teal'
        ...
        <div className="px-5 py-4 border-t border-white/10">
          <p className="text-white/40 text-xs">Instructor Portal</p>
        </div>
      </aside>
    </>
  );
